...
[QueryNonClientRegion](#querynonclientregion) | This method can be used inside the [CoreWebView2CompositionController.NonClientRegionChanged](corewebview2compositioncontroller.md#nonclientregionchanged) event handler to get the list of rects of [CoreWebView2NonClientRegionKind](corewebview2nonclientregionkind.md) for the specific region that changed.
...
This method can be used inside the [CoreWebView2CompositionController.NonClientRegionChanged](corewebview2compositioncontroller.md#nonclientregionchanged) event handler to get the list of rects of [CoreWebView2NonClientRegionKind](corewebview2nonclientregionkind.md) for the specific region that changed.
