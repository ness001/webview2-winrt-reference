...
[CreateCoreWebView2ControllerOptions](#createcorewebview2controlleroptions) | Create a new [CoreWebView2ControllerOptions](corewebview2controlleroptions.md) object, which can be passed as a parameter in [CoreWebView2Environment.CreateCoreWebView2ControllerAsync](corewebview2environment.md#createcorewebview2controllerasync) and [CoreWebView2Environment.CreateCoreWebView2CompositionControllerAsync](corewebview2environment.md#createcorewebview2compositioncontrollerasync) function for multiple profiles support.
...
Create a new [CoreWebView2ControllerOptions](corewebview2controlleroptions.md) object, which can be passed as a parameter in [CoreWebView2Environment.CreateCoreWebView2ControllerAsync](corewebview2environment.md#createcorewebview2controllerasync) and [CoreWebView2Environment.CreateCoreWebView2CompositionControllerAsync](corewebview2environment.md#createcorewebview2compositioncontrollerasync) function for multiple profiles support.
The options is a settable property while the default for [CoreWebView2ControllerOptions.ProfileName](corewebview2controlleroptions.md#profilename) is an empty string and the default value for [CoreWebView2ControllerOptions.IsInPrivateModeEnabled](corewebview2controlleroptions.md#isinprivatemodeenabled) is `false`.
