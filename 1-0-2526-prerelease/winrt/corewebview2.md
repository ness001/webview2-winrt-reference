...
- Microsoft.Web.WebView2.Core.CoreWebView2.CustomDataPartitionId
...
- Microsoft.Web.WebView2.Core.CoreWebView2.PostWebMessageAsJsonWithAdditionalObjects
...
- Microsoft.Web.WebView2.Core.CoreWebView2.get_CustomDataPartitionId
...
- Microsoft.Web.WebView2.Core.CoreWebView2.put_CustomDataPartitionId
...
[PostWebMessageAsJsonWithAdditionalObjects](#postwebmessageasjsonwithadditionalobjects) | Same as [CoreWebView2.PostWebMessageAsJson](corewebview2.md#postwebmessageasjson), but also has support for posting DOM objects to page content.
...
Additionally, the order of messages that are posted between `PostWebMessageAsJson` and `PostWebMessageAsJsonWithAdditionalObjects` may not be preserved.
