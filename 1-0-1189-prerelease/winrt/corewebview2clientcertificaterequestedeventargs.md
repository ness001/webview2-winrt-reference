...
Members|Description
--|--
[AllowedCertificateAuthorities](#allowedcertificateauthorities) | The list contains distinguished names of certificate authorities allowed by the server.
...
[MutuallyTrustedCertificates](#mutuallytrustedcertificates) | Returns the list of [CoreWebView2Certificate](corewebview2certificate.md) when client certificate authentication is requested. The list contains mutually trusted CA certificate.
...
> readonly  [`IVectorView`](/uwp/api/Windows.Foundation.Collections.IVectorView-1)&lt;[CoreWebView2Certificate](corewebview2certificate.md)&gt; MutuallyTrustedCertificates

Returns the list of [CoreWebView2Certificate](corewebview2certificate.md) when client certificate authentication is requested. The list contains mutually trusted CA certificate.
...
>  [CoreWebView2Certificate](corewebview2certificate.md) SelectedCertificate
